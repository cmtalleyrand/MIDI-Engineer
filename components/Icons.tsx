...
export const Spinner = (props: IconProps) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 4.75V6.25m0 11.5v1.5m7.41-8.91l-1.06 1.06M4.65 19.35l1.06-1.06m12.7 0l-1.06-1.06M5.71 5.71l1.06 1.06m10.44 7.44h-1.5m-11.5 0H3.75"
    />
  </svg>
);
...
export const MusicNoteIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path
      fillRule="evenodd"
      d="M19.952 1.651a.75.75 0 01.298.6V11.25a5.25 5.25 0 01-10.5 0V8.365a.75.75 0 01.94-1.285 6.75 6.75 0 005.06-6.429.75.75 0 01.6-.6zM9.75 12a6.75 6.75 0 00-6.429-5.06.75.75 0 00-1.285.94V16.5a5.25 5.25 0 0010.5 0V12z"
      clipRule="evenodd"
    />
  </svg>
);

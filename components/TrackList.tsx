    ...
    <div className="w-full bg-gray-dark p-6 rounded-2xl shadow-2xl border border-gray-medium animate-slide-up">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 border-b border-gray-medium pb-4">
        <div>
          ...
          <p className="text-gray-400 truncate max-w-xs sm:max-w-md">
            File: <span className="font-mono text-brand-primary">{fileName}</span>
          </p>
        </div>
        <div className="flex items-center gap-2 mt-2 sm:mt-0">
          <button
            onClick={onSelectAll}
            className="flex items-center gap-2 px-4 py-2 bg-gray-medium/50 text-gray-300 rounded-lg hover:bg-gray-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            onClick={onReset}
            className="flex items-center gap-2 px-4 py-2 bg-gray-medium/50 text-gray-300 rounded-lg hover:bg-gray-medium transition-colors"
          >

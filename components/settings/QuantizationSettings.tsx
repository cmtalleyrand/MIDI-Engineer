...
export default function QuantizationSettings({ quantizationWarning }: QuantizationSettingsProps) {
    ...
    const { 
        primaryRhythm, secondaryRhythm, quantizeDurationMin, 
        shiftToMeasure, pruneOverlaps, pruneThresholdIndex 
    } = settings;
    const {
        setPrimaryRhythm, setSecondaryRhythm, setQuantizeDurationMin,
        setShiftToMeasure, setPruneOverlaps, setPruneThresholdIndex
    } = setters;

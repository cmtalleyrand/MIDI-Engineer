              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <span className="text-lg font-bold text-brand-primary">
                    {KEYS[group.winner.root]} {group.winner.mode}
                  </span>
                  {i === 0 && (
                    <span className="text-[10px] bg-brand-secondary/50 text-brand-primary px-1.5 py-0.5 rounded border border-brand-secondary">
                      Best Match
                    </span>
                  )}
                </div>
                <div className="text-right">
                  <div className="text-sm font-bold text-gray-300">
                    {Math.round(group.winner.score * 100)}%
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-2 text-[10px] text-gray-400">
                  ...
                  <div className="flex-grow bg-gray-700 h-1.5 rounded-full">
                    <div
                      ...
                      style={{ width: `${group.winner.diatonic * 100}%` }}
                    ></div>
                  </div>
                  <span className="w-8 text-right font-mono">
                    {Math.round(group.winner.diatonic * 100)}%
                  </span>
                </div>
                <div className="flex items-center gap-2 text-[10px] text-gray-400">
                  ...
                  <div className="flex-grow bg-gray-700 h-1.5 rounded-full">
                    <div
                      ...
                      style={{ width: `${group.winner.triad * 100}%` }}
                    ></div>
                  </div>
                  <span className="w-8 text-right font-mono">
                    {Math.round(group.winner.triad * 100)}%
                  </span>
                </div>
                <div className="flex items-center gap-2 text-[10px] text-gray-400">
                  ...
                  <div className="flex-grow bg-gray-700 h-1.5 rounded-full">
                    <div
                      ...
                      style={{ width: `${group.winner.tonic * 100}%` }}
                    ></div>
                  </div>
                  <span className="w-8 text-right font-mono">
                    {Math.round(group.winner.tonic * 100)}%
                  </span>
                </div>
              </div>

...
const PATTERNS: { id: DrumPattern; name: string; description: string }[] = [
  ...
  },
  {
    ...
    description:
      'Timpani on downbeats and dominant, rolls at phrase boundaries. Key-aware pitched notes.',
  },
  {
    id: 'brushes_ride',
    name: 'Brushes / Ride',
    description:
      'Ride quarter notes, cross-stick backbeat, ghost snare fills. Jazz feel, no hi-hats.',
  },
];
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            {PATTERNS.map((p) => (
              ...
              >
                <span
                  className={`text-sm font-bold block ${pattern === p.id ? 'text-brand-primary' : 'text-gray-200'}`}
                >
                  {p.name}
                </span>
              </button>
